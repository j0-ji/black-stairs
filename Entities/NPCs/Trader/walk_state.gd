...
func _on_enter() -> void:
	...
	if !navigation_agent_2d.velocity_computed.is_connected(on_safe_velocity_computed):
		navigation_agent_2d.velocity_computed.connect(on_safe_velocity_computed)
	character.current_walk_cycle = 0
	character.update_walk_cycles()

func _on_exit() -> void:
	navigation_agent_2d.velocity_computed.disconnect(on_safe_velocity_computed)
